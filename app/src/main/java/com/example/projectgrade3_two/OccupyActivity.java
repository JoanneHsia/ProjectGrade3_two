...
public class OccupyActivity extends AppCompatActivity {
    ...
    String item_id, user_id, test_bed,item_status;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_occSend.setVisibility(View.INVISIBLE);
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    TableRow trUndo = new TableRow(OccupyActivity.this);

                                    trUndo.setLayoutParams(row_layout);
                                    trUndo.setGravity(Gravity.CENTER_HORIZONTAL);

                                    TextView itemId = new TextView(OccupyActivity.this);
                                    itemId.setText(object.getString("item_id").trim());
                                    itemId.setLayoutParams(view_layout);

                                    TextView itemName = new TextView(OccupyActivity.this);
                                    itemName.setText(object.getString("item_name").trim());
                                    itemName.setLayoutParams(view_layout);

                                    btn_occSend.setVisibility(View.VISIBLE);


                                }

                            } else if (success.equals("2")) {
                                AlertDialog.Builder builder =  new AlertDialog.Builder(OccupyActivity.this);
                            ...
                            e.printStackTrace();
                            Toast.makeText(OccupyActivity.this, "err" + e, Toast.LENGTH_SHORT).show();
                        }
                    }
                }, new Response.ErrorListener() {
            @Override
